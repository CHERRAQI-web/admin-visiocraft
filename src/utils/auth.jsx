...
export const isAuthenticated = async () => {
  try {
    ...
    const response = await axios.get(`http://backend-visiocraft-production.up.railway.app/api/auth/me?t=${Date.now()}`, {
...
export const logout = async () => {
  try {
    await axios.post("http://backend-visiocraft-production.up.railway.app/api/auth/logout", {}, { 
      withCredentials: true,
